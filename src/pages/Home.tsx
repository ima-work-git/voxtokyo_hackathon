...
export default function Home() {
  ...
  const emergencySystemMessage: ChatMessage = useMemo(
    () => ({
      role: 'system',
      content: `あなたは日本の緊急通報（119/110）を受け付ける指令員です。通報者テキストを受け取り、必ず「消防(119) / 救急(119) / 警察(110)」のいずれかに判定してください。情報が足りない場合は聞き返しますが、判定自体は必ず行います。
